 ...
 * @author Joel
 */
public class JIFraToIroningMaster2 extends javax.swing.JInternalFrame {
    ...
    private class MyTraversalPolicy extends FocusTraversalPolicy {
        ...
        public Component getComponentAfter(Container aContainer, Component aComponent) {
            if (aComponent.equals(jcmbIroningMaster)) {
                return jcmbOrderNo;
    ...
    private void populatetable(int stslno) {
        try {
            ...
            con = new DBConnection().connect();
            stmt = con.createStatement();
            query = "select a.sl_no,b.order_no,b.student_name,e.iron_name,d.item_name,a.qty,a.date_given,a.date_recieved,a.status from trn_ironing a left join mst_student b on a.stsl_no = b.stsl_no left join mst_item d on a.item_no = d.item_no left join mst_ironing e on a.iron_no = e.iron_no where a.stsl_no = '" + stslno + "' and a.flag!='D'  and b.flag!='D'  and d.flag!='D'  and e.flag!='D'";
            rs = stmt.executeQuery(query);
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jtblIroningMaster.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtblIroningMasterMouseClicked(evt);
            }
        });
        ...
        jtblIroningMaster.getColumnModel().getColumn(5).setMinWidth(60);
        jtblIroningMaster.getColumnModel().getColumn(5).setPreferredWidth(60);
        jtblIroningMaster.getColumnModel().getColumn(5).setMaxWidth(60);
        jtblIroningMaster.getColumnModel().getColumn(6).setMinWidth(80);
        jtblIroningMaster.getColumnModel().getColumn(6).setPreferredWidth(80);
        jtblIroningMaster.getColumnModel().getColumn(6).setMaxWidth(80);
        jtblIroningMaster.getColumnModel().getColumn(7).setMinWidth(85);
        jtblIroningMaster.getColumnModel().getColumn(7).setPreferredWidth(85);
        jtblIroningMaster.getColumnModel().getColumn(7).setMaxWidth(85);
        jtblIroningMaster.getColumnModel().getColumn(8).setMinWidth(70);
        jtblIroningMaster.getColumnModel().getColumn(8).setPreferredWidth(70);
        jtblIroningMaster.getColumnModel().getColumn(8).setMaxWidth(70);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jcmbItem, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            if (!jcmbOrderNo.getSelectedItem().equals("")) {
                try {
                    ...
                    query = "select distinct(a.item_no),b.item_name from trn_stitching a join mst_item b on a.item_no = b.item_no where a.stsl_no = '" + stsl + "' and a.status = 'C' and b.buttonhole = '0' and a.flag!='D' and b.flag!='D' union "
                            + "select distinct(a.item_no),b.item_name from trn_buttonhole a join mst_item b on a.item_no = b.item_no where a.stsl_no = '" + stsl + "' and a.status = 'C' and b.buttonhole = '1' and a.flag!='D' and b.flag!='D'";
                    rs = stmt.executeQuery(query);
        ...
        if (jcmbIroningMaster.getSelectedItem().equals("")) {
            ...
            try {
                ...
                if (jcmbItem.getSelectedItem().equals("All")) {
                    query = "select a.item_no,sum(a.qty) from trn_stitching a join mst_item b on a.item_no = b.item_no where a.stsl_no = '" + stsl + "' and b.buttonhole = '0' and a.status = 'C' and a.flag!='D' and b.flag!='D' group by a.item_no union "
                            + "select a.item_no,sum(a.qty) from trn_buttonhole a join mst_item b on a.item_no = b.item_no where a.stsl_no = '" + stsl + "' and b.buttonhole = '1' and a.status = 'C' and a.flag!='D' and b.flag!='D' group by a.item_no";
                    rs = stmt.executeQuery(query);
                    while (rs.next()) {
                        query = "select item_no,sum(qty) from trn_ironing where stsl_no = '" + stsl + "' and item_no ='" + rs.getString(1) + "' and flag!='D' group by item_no";
                        rs1 = stmt1.executeQuery(query);
                        if (rs1.next()) {
                            temp = rs.getInt(2) - rs1.getInt(2);
                            if (temp > 0) {
                                query = "select sl_no,qty from trn_ironing where stsl_no ='" + stsl + "' and item_no = '" + rs.getString(1) + "' and date_given = '" + today + "' and iron_no = '" + ironno[0] + "' and status='P' and flag!='D'";
                                ...
                                if (rs2.next()) {
                                    ...
                                    query = "insert into trn_ironing(iron_no,stsl_no,item_no,qty,status,date_given,flag,date_created) values('" + ironno[0] + "','" + stsl + "','" + rs.getString(1) + "','" + temp + "','P','" + new SimpleDateFormat("yyyy-MM-dd").format(jdteDate.getDate()) + "','I','" + today + "')";
                                    i = i + stmt2.executeUpdate(query);
                                }
                            }
                        } else {
                            query = "insert into trn_ironing(iron_no,stsl_no,item_no,qty,status,date_given,flag,date_created) values('" + ironno[0] + "','" + stsl + "','" + rs.getString(1) + "','" + rs.getString(2) + "','P','" + new SimpleDateFormat("yyyy-MM-dd").format(jdteDate.getDate()) + "','I','" + today + "')";
                    ...
                    if (jtxtQty.getText().equals("")) {
                        ...
                        query = "select a.item_no,sum(a.qty) from trn_stitching a join mst_item b on a.item_no = b.item_no where a.stsl_no = '" + stsl + "' and b.buttonhole = '0' and a.item_no = '" + itemno[0] + "' and a.status = 'C' and a.flag!='D' and b.flag!='D' group by a.item_no union "
                                + "select a.item_no,sum(a.qty) from trn_buttonhole a join mst_item b on a.item_no = b.item_no where a.stsl_no = '" + stsl + "' and b.buttonhole = '1' and a.item_no = '" + itemno[0] + "' and a.status = 'C' and a.flag!='D' and b.flag!='D' group by a.item_no";
                        rs = stmt.executeQuery(query);
                        if (rs.next()) {
                            if (rs.getInt(2) >= Integer.parseInt(jtxtQty.getText())) {
                                query = "select item_no,sum(qty) from trn_ironing where stsl_no = '" + stsl + "' and item_no ='" + itemno[0] + "' and flag!='D' group by item_no";
                                rs1 = stmt1.executeQuery(query);
                                if (rs1.next()) {
                                    temp = rs.getInt(2) - rs1.getInt(2);
                                    if (temp > 0) {
                                        if (temp >= Integer.parseInt(jtxtQty.getText())) {
                                            ...
                                            if (rs2.next()) {
                                                ...
                                                query = "insert into trn_ironing(iron_no,stsl_no,item_no,qty,status,date_given,flag,date_created) values('" + ironno[0] + "','" + stsl + "','" + itemno[0] + "','" + jtxtQty.getText() + "','P','" + new SimpleDateFormat("yyyy-MM-dd").format(jdteDate.getDate()) + "','I','" + today + "')";
                                                i = i + stmt2.executeUpdate(query);
                                            }
                                        } else {
    ...
    private void jbtnTakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnTakeActionPerformed
        try {
            if (jtblIroningMaster.getRowCount() > 0) {
                if (jtblIroningMaster.getSelectedRow() < 0) {
                    int b = JOptionPane.showConfirmDialog(this, "Do you want a take 'ALL' items from the ironing master?", "Confirm", JOptionPane.YES_NO_OPTION);
                    if (b == JOptionPane.YES_OPTION) {
                        temp = 0;
                        for (int i = 0; i < jtblIroningMaster.getRowCount(); i++) {
                            if (jtblIroningMaster.getValueAt(i, 8).toString().equals("C")) {
                                temp++;
                            }
                        }
                        if (temp != jtblIroningMaster.getRowCount()) {
                            temp = 0;
                            con = new DBConnection().connect();
                            con.setAutoCommit(false);
                            stmt = con.createStatement();
                            ...
                            for (int i = 0; i < jtblIroningMaster.getRowCount(); i++) {
                                if (jtblIroningMaster.getValueAt(i, 8).toString().equals("P")) {
                                    query = "update trn_ironing set date_recieved='" + new SimpleDateFormat("yyyy-MM-dd").format(jdteTakeDate.getDate()) + "', date_updated='" + today + "',flag='I',status ='C' where sl_no = '" + jtblIroningMaster.getValueAt(i, 0) + "' ";
                    ...
                    JOptionPane.showMessageDialog(this, "Please select a date", "Info", JOptionPane.INFORMATION_MESSAGE);
                } else if (jtblIroningMaster.getValueAt(jtblIroningMaster.getSelectedRow(), 8).toString().equals("C")) {
                    ...
                    if (b == JOptionPane.YES_OPTION) {
                        if (Integer.parseInt(jtxtQty1.getText()) > 0) {
                            ...
                            if (Integer.parseInt(jtxtQty1.getText()) == takenqty) {
                                query = "update trn_ironing set date_recieved='" + new SimpleDateFormat("yyyy-MM-dd").format(jdteTakeDate.getDate()) + "', date_updated='" + today + "',flag='I',status ='C' where sl_no = '" + slno + "' ";
                                i = stmt.executeUpdate(query);
                            } else if (Integer.parseInt(jtxtQty1.getText()) < takenqty) {
                                temp = takenqty - Integer.parseInt(jtxtQty1.getText());
                                query = "update trn_ironing set date_updated = '" + today + "', flag = 'I', qty = '" + temp + "'  where sl_no = '" + slno + "' ";
                                i = stmt.executeUpdate(query);
                                query = "select iron_no,stsl_no,item_no,qty,status,date_given,flag,date_created from trn_ironing where sl_no = '" + slno + "' and flag!='D'";
                                rs = stmt.executeQuery(query);
                                if (rs.next()) {
                                    query = "insert into trn_ironing(iron_no,stsl_no,item_no,qty,status,date_given,date_recieved,flag,date_created) values('" + rs.getString(1) + "','" + rs.getString(2) + "','" + rs.getString(3) + "','" + jtxtQty1.getText() + "','C','" + new SimpleDateFormat("yyyy-MM-dd").format(jdteTakeDate.getDate()) + "','" + today + "','I','" + rs.getString(8) + "')";
                                    i = i + stmt2.executeUpdate(query);
                                }
                            }
                            if (i > 0) {
    ...
    private void jBtnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnDeleteActionPerformed
        if (jtblIroningMaster.getRowCount() > 0) {
            if (jtblIroningMaster.getSelectedRow() > -1) {
                ...
                if (b == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        query = "update trn_ironing set date_updated='" + today + "',flag='D' where sl_no = '" + jtblIroningMaster.getValueAt(jtblIroningMaster.getSelectedRow(), 0) + "' ";
    ...
    private void jtblIroningMasterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblIroningMasterMouseClicked
        if (jtblIroningMaster.getSelectedRow() > -1) {
            jtxtQty1.setText(jtblIroningMaster.getValueAt(jtblIroningMaster.getSelectedRow(), 5).toString());
            takenqty = Integer.parseInt(jtblIroningMaster.getValueAt(jtblIroningMaster.getSelectedRow(), 5).toString());
            slno = Integer.parseInt(jtblIroningMaster.getValueAt(jtblIroningMaster.getSelectedRow(), 0).toString());
        }
    }//GEN-LAST:event_jtblIroningMasterMouseClicked
