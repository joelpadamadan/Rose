 ...
 * @author Joel
 */
public class JIFraViewAllStudent extends javax.swing.JInternalFrame {
    ...
    float gt = 0, material_total = 0, item_total = 0, diff = 0;
    String today = new SimpleDateFormat("dd-MM-yy").format(new Date());
    boolean check = false;
    

    /**
     * Creates new form JIFraViewAllStudent
     */
    public JIFraViewAllStudent() {
        try {
            initComponents();
        ...
        try {
            ...
            if (jcmbDivision.getSelectedItem() != null && !jcmbDivision.getSelectedItem().equals("")) {
                if ((jcmbClass.getSelectedItem() == null || jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() == null || jcmbGender.getSelectedItem().equals(""))) {
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "' and a.division = '" + jcmbDivision.getSelectedItem() + "' and a.flag != 'D' and b.flag != 'D'");
                    ...
                    //class
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "'  and a.division = '" + jcmbDivision.getSelectedItem() + "' and a.class_no = '" + classno + "' and a.flag != 'D' and b.flag != 'D'");
                } else if ((jcmbClass.getSelectedItem() == null || jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() != null || !jcmbGender.getSelectedItem().equals(""))) {
                    //gender
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "'  and a.division = '" + jcmbDivision.getSelectedItem() + "' and a.gender = '" + jcmbGender.getSelectedItem() + "' and a.flag != 'D' and b.flag != 'D'");
                } else if ((jcmbClass.getSelectedItem() != null || !jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() != null || !jcmbGender.getSelectedItem().equals(""))) {
                    //class
                    //gender
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "'  and a.division = '" + jcmbDivision.getSelectedItem() + "' and a.class_no = '" + classno + "' and a.gender = '" + jcmbGender.getSelectedItem() + "' and a.flag != 'D' and b.flag != 'D'");
                }
            } else {
                if ((jcmbClass.getSelectedItem() == null || jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() == null || jcmbGender.getSelectedItem().equals(""))) {
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "' and a.flag != 'D' and b.flag != 'D'");
                } else if ((jcmbClass.getSelectedItem() != null || !jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() == null || jcmbGender.getSelectedItem().equals(""))) {
                    //class
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "' and a.class_no = '" + classno + "' and a.flag != 'D' and b.flag != 'D'");
                } else if ((jcmbClass.getSelectedItem() == null || jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() != null || !jcmbGender.getSelectedItem().equals(""))) {
                    //gender
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "' and a.gender = '" + jcmbGender.getSelectedItem() + "' and a.flag != 'D' and b.flag != 'D'");
                } else if ((jcmbClass.getSelectedItem() != null || !jcmbClass.getSelectedItem().equals("")) && (jcmbGender.getSelectedItem() != null || !jcmbGender.getSelectedItem().equals(""))) {
                    //class
                    //gender
                    generatetable("select a.stsl_no,a.order_no,a.student_name,b.class,a.division,a.gender from mst_student a join mst_class b on a.class_no = b.class_no where school_no = '" + schoolno + "' and a.class_no = '" + classno + "' and a.gender = '" + jcmbGender.getSelectedItem() + "' and a.flag != 'D' and b.flag != 'D'");
                }
            }
...
//                }
                if (!check) {
                    query = "select c.material_name,a.fixed_mat_length,b.item_name,e.selling_price,f.qty from mst_student_mat_detail a join mst_item b on a.item_no = b.item_no join mst_material c on a.material_no = c.material_no join mst_school_mat_price e on a.material_no = e.material_no and a.item_no = e.item_no join mst_student_detail f on a.stsl_no = f.stsl_no and a.item_no = f.item_no where a.stsl_no =  '" + stsl + "' and e.school_no = '" + schoolno + "' and a.flag!='D' and b.flag!='D' and c.flag!='D' and e.flag!='D' and f.flag!='D'";
                    rs2 = stmt2.executeQuery(query);
                    while (rs2.next()) {
                        material_total = material_total + (rs2.getFloat(2) * rs2.getFloat(4)) * rs2.getInt(5);
                    }
                    query = "select a.item_no,a.qty,b.item_name,d.selling_price from mst_student_detail a join mst_item b on a.item_no = b.item_no join mst_school_item_price d on a.item_no = d.item_no where a.stsl_no = '" + stsl + "' and d.school_no = '" + schoolno + "' and a.flag!='D' and b.flag!='D' and d.flag!='D'";
                    rs2 = stmt2.executeQuery(query);
                    while (rs2.next()) {
