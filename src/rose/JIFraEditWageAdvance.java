 ...
 * @author Betsy
 */
public class JIFraEditWageAdvance extends javax.swing.JInternalFrame {
    ...
    private void populatestitching() {
        try {
            ...
            int j = 0;
            query = "select a.sl_no,a.labour_type,b.tailor_name,a.date_given,a.amount from mst_wage_advance a join mst_tailor b on a.labour_no = b.tailor_no  where a.labour_type= 'Stitching' and b.tailor_no = '" + LabourerNo[0] + "' and a.flag!='D' and b.flag!='D' order by a.sl_no desc";
    ...
    private void populatecutting() {
        try {
            ...
            int j = 0;
            query = "select a.sl_no,a.labour_type,b.cutting_master,a.date_given,a.amount from mst_wage_advance a join mst_group b on a.labour_no = b.group_no  where a.labour_type= 'Cutting' and b.group_no = '" + LabourerNo[0] + "' and a.flag!='D' and b.flag!='D' order by a.sl_no desc";
            rs = stmt.executeQuery(query);
            for (j = 0; rs.next(); j++) {
                model.addRow(new Object[]{""});
                jtblWageAdvance.setValueAt(rs.getString(1), j, 0);
    ...
    private void jbtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEditActionPerformed
        if (jtblWageAdvance.getSelectedRow() != -1) {
            try {
                ...
                jtxtAmount.setText(jtblWageAdvance.getValueAt(jtblWageAdvance.getSelectedRow(), 4).toString());
                jdteDate.setDate(new SimpleDateFormat("yyyy-MM-dd").parse(jtblWageAdvance.getValueAt(jtblWageAdvance.getSelectedRow(), 3).toString()));
    ...
    private void jbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSaveActionPerformed
        if (slno == 0) {
            ...
            try {
                con = new DBConnection().connect();
                stmt = con.createStatement();
                query = "UPDATE mst_wage_advance SET AMOUNT ='" + jtxtAmount.getText() + "', DATE_GIVEN ='" + new SimpleDateFormat("yyyy-MM-dd").format(jdteDate.getDate()) + "', FLAG='U',DATE_UPDATED='" + today + "' WHERE SL_NO='" + slno + "'";
        ...
        if (slno != 0) {
            ...
            try {
                ...
                if (b == JOptionPane.YES_OPTION) {
                    ...
                    con = new DBConnection().connect();
                    stmt = con.createStatement();
                    query = "UPDATE mst_wage_advance SET FLAG='D',DATE_UPDATED='" + today + "' WHERE SL_NO='" + slno + "'";
                    int i = stmt.executeUpdate(query);
                    if (i > 0) {
